...
export default function Login() {
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-background p-4">
      {isAuthenticated && (
        <div className="w-full max-w-md mb-4 p-3 bg-muted border border-border rounded-lg flex items-center justify-between">
          <p className="text-sm text-muted-foreground">Logged in as <strong>{user?.phone}</strong></p>
